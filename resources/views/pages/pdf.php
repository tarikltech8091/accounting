...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <!-- Title here -->
    <title>Goedkoopste Beltegoed</title>
    <!-- Favicon -->
    ...
    <main>
      <div id="details" class="clearfix">
        ...
        <div class="content_right">
          <p><span>Date:</span> 31-1-2015</p> 
          <p><span>Voucher No:</span> 2013008051</p>
        </div>
      </div>

      <div id="client">
          <div class="to">Journal</div>                  
       </div>
      ...
      <div class="invoice-list">
        ...
        <ul class="voucher_head">
         ...
         <ul class="voucher_content">
           <li  style="width:100px; ">2 August, 2016</li>
           <li  style="width:325px;"><span>House rent</span><br/>
				 	<i style="margin-left:10px; font-size:12px">(Office employee)</i></li>
           <li  style="width:135px;text-align:center;font-weight:bold;">121212</li>
           <li  style="width:135px;"></li>
        </ul>
        <ul class="voucher_content">
           <li  style="width:100px; ">2 August, 2016</li>
           <li  style="width:325px;text-align:center;"><span>House rent</span><br/>
				 	<i style="margin-left:10px; font-size:12px">(Office employee)</i></li>
           <li  style="width:135px;"></li>
           <li  style="width:135px;text-align:center;font-weight:bold;">121212</li>
        </ul>
      ...
      <div class="total_block">
      	<ul>
      		...
      		<li style="width:135px;text-align:center;font-weight:bold;">Tk 121212</li>
      		<li style="width:135px;text-align:center;font-weight:bold;">Tk 121212</li>
      	</ul>
      </div>
      <div class="amounts_in_word">
      	<p><strong>Amount In words:</strong> Two Hundred Taka Only</p>
      </div>
