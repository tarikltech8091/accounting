	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form method="get" action="{{url('/general/transaction-list/by-user')}}">
							...
							<div class="form-group ">
								...
								<div class="input-group">
									<select name="post_type" class="form-control">
										...
										<option {{(isset($_GET['post_type']) && ($_GET['post_type'] == $list->posting_type_id)) ? 'selected':''}} value="{{$list->posting_type_id}}">{{$list->posting_type}}</option>
