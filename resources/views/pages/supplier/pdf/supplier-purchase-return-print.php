...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <!-- Title here -->
    <title><?php echo isset($page_title) ? $page_title:'Purchase Return'; ?></title>
    ...
    <main>
      <div id="details" class="clearfix">
        ...
        <div class="content_right">
          <p><span>Date: <?php echo isset($all_stocks_transaction->stocks_transaction_date) ? date('j M, Y',strtotime($all_stocks_transaction->stocks_transaction_date)):'';?></span></p> 
          <p><span>Bill No: <?php echo isset($all_stocks_transaction->stocks_transaction_date) ? date('Ymd',strtotime($all_stocks_transaction->stocks_transaction_date)):'';?><?php echo isset($all_stocks_transaction->stocks_transactions_id) ? $all_stocks_transaction->stocks_transactions_id:'';?></span></p>
        </div>
      </div>
      <div id="client">
          <div class="to"><?php echo isset($page_title) ? $page_title:'Purchase Return'; ?></div>                  
       </div>
        ...
        <ul class="voucher_head">
           ...
           <li  style="width:135px; font-weight: bold;">Amount (Tk)</li>
                  ...
                  <ul class="voucher_content">
                    ...
                    <li  style="width:325px;padding-left:10px;"><strong><?php echo isset($all_stocks_transaction->item_name) ? $all_stocks_transaction->item_name:'';?></strong></li>
                    <li  style="width:70px; text-align:center;font-weight:bold;"><?php echo isset($all_stocks_transaction->transaction_stocks_quantity) ? $all_stocks_transaction->transaction_stocks_quantity:'';?><?php echo isset($all_stocks_transaction->item_quantity_unit) ? $all_stocks_transaction->item_quantity_unit:'';?></li>
                    <li  style="width:115px;text-align:center;font-weight:bold;">Tk <?php echo isset($all_stocks_transaction->stocks_quantity_rate) ? number_format($all_stocks_transaction->stocks_quantity_rate,2,'.','' ):'';?></li>
                    <li  style="width:135px; text-align:center;font-weight:bold;">Tk <?php echo isset($all_stocks_transaction->stocks_quantity_cost) ? number_format($all_stocks_transaction->stocks_quantity_cost,2,'.','' ):'';?></li>
      ...
      <div class="amounts_in_word">
        ...
        <?php
          if(is_numeric($all_stocks_transaction->stocks_quantity_cost)){
            $amount_words = \App\System::ConvertNumberToWords($all_stocks_transaction->stocks_quantity_cost);
