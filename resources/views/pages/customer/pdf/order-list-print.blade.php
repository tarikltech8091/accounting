  ...
  <!-- <body> -->
    ...
    <main>
      ...
      <div class="invoice-list">
        <h3 align="center">From : <?php echo (isset($search_from)? $search_from :''). ' - To : '.(isset($search_to)? $search_to :'') ; ?></h3>
        <ul class="voucher_head">
           <li  style="width:50px; font-weight: bold;">SL</li>
           <li  style="width:70px; font-weight: bold;">Order Date</li>
           <li  style="width:140px; font-weight: bold;">Descriptipn</li>
           <li  style="width:80px; font-weight: bold;">Delivary Date</li>
           <li  style="width:75px; font-weight: bold;">Customer</li>
           <li  style="width:90px; font-weight: bold;">Cost Center</li>
           <li  style="width:100px; font-weight: bold;">Amount (Tk)</li>
           <li  style="width:80px; font-weight: bold;">Order Status </li>
        </ul>
      ...
      @foreach($all_order_list as $key => $list)
		  <ul class="voucher_content">
			  ...
			  <li  style="width:70px;font-weight:bold;"><span>{{$list->order_date}}</span></li>
        <li  style="width:140px; text-align:center;font-weight:bold;"><?php echo substr($list->order_description,0,20) ;?></li>
	    	<li  style="width:80px;text-align:center;font-weight:bold;">{{$list->order_delivery_date}}</li>
        <li  style="width:75px; text-align:center;font-weight:bold;">{{$list->customer_company}}</li>
        <li  style="width:90px; text-align:center;font-weight:bold;">{{$list->cost_center_name}}</li>
        <li  style="width:100px; text-align:center;font-weight:bold;">{{$list->order_net_amount}}</li>
	    	<li  style="width:80px; text-align:center;font-weight:bold;">
      ...
      <div class="total_block">
        <ul>
          <li style="width:495px;text-align:center;font-weight:bold;">Grand Total</li>
          <li style="width:200px;text-align:center;font-weight:bold;">{{isset($total_amount)?($total_amount):' 00.00 '}} </li>
        </ul>
      </div>
      ...
      <div class="amounts_in_word">
          ...
          <?php
            if(is_numeric($total_amount)){
              $amount_words = \App\System::ConvertNumberToWords($total_amount);
