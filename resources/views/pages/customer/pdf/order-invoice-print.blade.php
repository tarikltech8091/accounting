  ...
  <body onload="window.print();" onfocus="window.close()">
    ...
    <main>
      ...
      @foreach($ltech_sales_order_details as $key => $list)
        ...
        <li  style="width:70px; text-align:center;font-weight:bold;">{{$list->order_item_deliverd_quantity}}</li>
	    	<li  style="width:115px;text-align:center;font-weight:bold;">{{$list->order_item_deliverd_quantity_rate}}</li>
	    	<li  style="width:135px; text-align:center;font-weight:bold;">{{$list->order_item_deliverd_cost}}</li>
	    </ul>
      @endforeach
      @endif
      ...
      <div class="total_block">
        <ul>
          ...
          <li style="width:135px;text-align:center;font-weight:bold;">{{isset($ltech_sales_orders->order_delivery_net_amount)?($ltech_sales_orders->order_delivery_net_amount):' 00.00 '}} </li>
        </ul>
      </div>
      ...
      <div class="amounts_in_word">
          ...
          <?php
            if(is_numeric($ltech_sales_orders->order_delivery_net_amount)){
              $amount_words = \App\System::ConvertNumberToWords($ltech_sales_orders->order_delivery_net_amount);
