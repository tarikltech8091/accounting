		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="col-md-3 pull-right">
					<div class="row">
						<p class="pull-right">
							<a href="{{url('/customer/order/download/'.$ltech_sales_orders->order_id)}}" class="btn btn-success tooltips" data-toggle1="tooltip" title="Order Detail PDF">Download<i class="fa fa-print" aria-hidden="true"></i></a>
							<a href="{{url('/customer/sales/invoice/print/order-'.$ltech_sales_orders->order_id)}}" target="_blank" class="btn btn-success hidden-print">Print <i class="fa fa-print"></i></a>
						</p>
					</div>
