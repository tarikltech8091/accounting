		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="col-md-3 pull-right">
					<div class="row">
						<p class="pull-right">
							<a href="{{url('/customer/sales/invoice/download/pdf/order-'.$ltech_sales_orders->order_id)}}" class="btn btn-success tooltips" data-toggle1="tooltip" title="Order Detail PDF">Download<i class="fa fa-print" aria-hidden="true"></i></a>
							<a href="{{url('/customer/order/print/'.$ltech_sales_orders->order_id)}}" target="_blank" class="btn btn-success hidden-print">Print <i class="fa fa-print"></i></a>
						</p>
					</div>

					<div class="row">
						<p class="pull-right">
						<strong>Order No:</strong>{{ date('Ymd',strtotime($ltech_sales_orders->order_date))}}{{isset($ltech_sales_orders->order_id)?($ltech_sales_orders->order_id):' 0 '}}
						<br>
					...
					<table class="table table-hover table-bordered table-striped nopadding">
						...
						@endif
							<tr>
				                ...
				                <td><strong>{{isset($ltech_sales_orders->order_delivery_net_amount)?($ltech_sales_orders->order_delivery_net_amount):' 00.00 '}} Tk</strong></td>
							</tr>
