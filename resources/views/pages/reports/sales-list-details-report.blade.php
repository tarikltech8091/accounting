	...
	<div class="col-md-12">
		...
		<?php $company_details=\DB::table('company_details')->latest()->first(); ?>
			...
			<div class="panel panel-heading" align="center">
				...
				<a target="_blank" href="{{url('/reports/sales-list/pdf/from-'.(isset($search_from)? $search_from :'').'/to-'.(isset($search_to)? $search_to :'').'/cid-'.(isset($cost_center_id)? $cost_center_id :'').'/type-'.(isset($type)? $type :''))}}" class="btn btn-xs btn-green tooltips pull-right" data-toggle1="tooltip" title="Sales PDF Download" style="margin-left:10px;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>

				<a target="_blank" href="{{url('/reports/sales-list/print/from-'.(isset($search_from)? $search_from :'').'/to-'.(isset($search_to)? $search_to :'').'/cid-'.(isset($cost_center_id)? $cost_center_id :'').'/type-'.(isset($type)? $type :''))}}" class="btn btn-xs btn-green tooltips pull-right" data-toggle1="tooltip" title="Sales PDF Print" ><i class="fa fa-print" aria-hidden="true"></i></a>
			</div>
