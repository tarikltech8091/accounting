...
.content_right span {
  ...
  <body >
    ...
    <?php $company_details=\DB::table('company_details')->latest()->first(); ?>
      ...
      <div id="client">
          <div class="to"><strong> Purchase Report </strong></div>                  
       </div>
      ...
      <div class="invoice-list">
        ...
        <ul class="voucher_head">
            ...
            <li  style="width:270px; font-weight: bold;">Balance</li>
        </ul>
      ...
      <?php
        ...
        if(!empty($purchase_item_data) && count($purchase_item_data)>0){
          foreach($purchase_item_data as $key => $list){
      ?>
              <ul class="voucher_content">
                <li  style="width:425px; text-align:center;"><span>{{isset($list['item_name'])? $list['item_name'] :'' }}</span><br/>
                <?php
