  ...
  <!-- <body > -->
    ...
    <?php $company_details=\DB::table('company_details')->latest()->first(); ?>
      ...
      <?php
                  ...
                  $total_opening_cost=$total_opening_cost+(isset($stock_summery_opening_list->opening_transaction_stocks_cost)? ($stock_summery_opening_list->opening_transaction_stocks_cost) :$open_cost);
