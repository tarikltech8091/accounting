    ...
    <main>
      <div id="details" class="clearfix">
        <div class="content_left">
          ...
          <p><span>Supplier Details</span><br/>
          Tarik
          <br/>13/2 West Panthpath,Dhaka 1207</p>
        </div>

        <div class="content_right">
          <p><span>Date: 28-12-2016</span></p> 
          <p><span>Bill No: *******</span></p>
        </div>
      </div>
      <div id="client">
      ...
      <div class="invoice-list">
		...
		<ul class="voucher_content">
			<li  style="width:50px; text-align:center;font-weight:bold;">#</li>
			<li  style="width:325px;font-weight:bold;"><span>Buttons</span></li>
            <li  style="width:70px; text-align:center;font-weight:bold;">300</li>
	    	<li  style="width:115px;text-align:center;font-weight:bold;">5 Tk</li>
	    	<li  style="width:135px; text-align:center;font-weight:bold;">1500 Tk</li>
	    </ul>
      ...
      <div class="amounts_in_word">
      	<p><strong>Amount In words:</strong> Fifteen hundred taka only.
		</p>
      </div>
